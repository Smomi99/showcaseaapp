    ...
    <div className="mb-32">
      ...
      <div className="mt-8 mb-4 text-md text-center font-semibold ">
        ...
        <h1 className="text-gray-500 w-full  p-4">
          It happens! Fortunately you can enter your email address and <br />
          if we have an account on file we’ll send a password reset link
        </h1>
      </div>
      <div className="mx-auto rounded-2xl bg-white pb-2 drop-shadow-2xl md:w-1/2">
        <div className="p-8">
          ...
          <p className="text-gray-300 mb-6">
            Please enter your Showcase account email address{" "}
          </p>
          <hr />
          <div className="flex justify-between gap-4 mb-4 grid grid-cols-4">
            <div></div>
